  ...
  return (
    ...
    <div className="App">
      ...
      <div style={{padding:'10px'}}/>
          ...
          <p id='key2' data-testid='resultKey2'></p>
          ...
          <button onClick={() => setStorage( 'session', 'set', "myId2", 2)}>Set the key 'myId2' to 2</button>
          <button onClick={() => setStorage( 'session', 'get', "myId2")}>Get 'myId2' value</button>
          <p id='key3' data-testid='resultKey3'></p>
          ...
          <p id='key4' data-testid='resultKey4'></p>
